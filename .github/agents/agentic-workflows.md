...
**Load when**: The workflow needs compact charts that render reliably in GitHub issues, comments, or discussions

**Prompt file**: `https://raw.githubusercontent.com/github/gh-aw/v0.82.14/.github/aw/asciicharts.md`

**Use cases**:
- "Add an ASCII bar chart to the weekly report"
- "Render coverage trends as a markdown chart"
- "Show a sparkline in the status comment"
