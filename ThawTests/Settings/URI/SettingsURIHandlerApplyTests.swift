...
/// `UserDefaults.standard`, so the suite snapshots the app's persistent
/// domain and restores it afterwards.
@MainActor
@Suite("Settings URI handler apply", .serialized)
final class SettingsURIHandlerApplyTests {
    ...
    func unknownKeyIsRefused(_ key: String) {
    ...
    func truthySpellingsApply(_ value: String) {
    ...
    func unparsableBooleanIsRefused() {
    ...
    func booleanSetPostsANotification() {
    ...
    func nonBooleanKeyCannotBeToggled(_ key: String) {
        #expect(!SettingsURIHandler.handleToggle(key: key, sender: "test"))
    }

    @Test("A toggle announces the new value")
    func togglePostsTheNewValue() {
        Defaults.set(false, forKey: .autoRehide)
    ...
    func outOfRangeDoubleIsClamped() {
    ...
    func eachDoubleKeyHasItsOwnRange() {
    ...
    func nonFiniteDoubleIsRefused(_ value: String) {
    ...
    func unparsableDoubleIsRefused() {
        Defaults.set(30.0, forKey: .rehideInterval)
    ...
    func doubleSetAnnouncesTheClampedValue() {
        let posted = notifications(named: .settingsDidChangeViaURI) {
    ...
    func rehideStrategyIsAccepted(_ pair: (String, Int)) {
    ...
    func unknownRehideStrategyIsRefused(_ value: String) {
    ...
    func enumSetAnnouncesItsRawValue() {
        let posted = notifications(named: .settingsDidChangeViaURI) {
    ...
    func alwaysShowHiddenItemsScope() {
        let posted = notifications(named: .perDisplaySettingsDidChangeViaURI) {
    ...
    func perDisplaySetDoesNotTouchDefaults() {
    ...
    func invalidPerDisplayBooleanIsRefused(_ key: String) {
    ...
    func iceBarLocationIsAccepted(_ value: String) {
    ...
    func unknownIceBarLocationIsRefused(_ value: String) {
        #expect(!SettingsURIHandler.handleSet(key: "iceBarLocation", value: value, sender: "test"))
    }

    @Test("iceBarLayout accepts names and raw values", arguments: ["horizontal", "vertical", "grid", "0", "1", "2"])
    func iceBarLayoutIsAccepted(_ value: String) {
    ...
    func nonNumericGridColumnsIsRefused(_ value: String) {
    ...
    func malformedDisplayUUIDIsRefused() {
        #expect(
    ...
    func unknownDisplayUUIDIsRefused() {
        #expect(
            !SettingsURIHandler.handleSet(
                key: "useIceBar",
                value: "true",
    ...
    func perDisplayToggleValidatesTheUUIDShape() {
    ...
    func iceBarLocationCannotBeToggled() {
    ...
    func perDisplayToggleIsAnnounced() {
        let posted = notifications(named: .perDisplaySettingsDidChangeViaURI) {
    ...
    func whitelistDoesNotDuplicate() {
        Defaults.removeObject(forKey: .settingsURIWhitelist)
    ...
    func removingAnAbsentEntryIsHarmless() {
        Defaults.removeObject(forKey: .settingsURIWhitelist)
        SettingsURIHandler.addToWhitelist(bundleId: "com.example.Alpha")
    ...
    @Test("Removing an entry announces the change")
    func whitelistChangesAreAnnounced() {
        Defaults.removeObject(forKey: .settingsURIWhitelist)
