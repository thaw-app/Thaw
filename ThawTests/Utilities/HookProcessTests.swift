...
struct HookProcessTests {
    ...
    private static func waitUntilTerminated(_ process: HookRunner.HookProcess) async throws {
        for _ in 0 ..< 500 {
            if !process.isRunning {
                return
            }
    ...
    private static func waitUntilGroupDrained(_ process: HookRunner.HookProcess) async throws {
        for _ in 0 ..< 500 {
            _ = process.isRunning
